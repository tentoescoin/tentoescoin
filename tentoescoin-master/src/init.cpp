    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("SmallChange version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  tentoescoin [options]                     " + "\n" +
                  "  tentoescoin [options] <command> [params]  " + _("Send command to -server or tentoescoin") + "\n" +
                  "  tentoescoin [options] help                " + _("List commands") + "\n" +
                  "  tentoescoin [options] help <command>      " + _("Get help for a command") + "\n";
        ...
        for (int i = 1; i < argc; i++)
            if (!IsSwitchChar(argv[i][0]) && !boost::algorithm::istarts_with(argv[i], "tentoescoin:"))
                fCommandLine = true;
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: tentoescoin.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: tentoescoin.pid)") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 17779 or testnet: 17774)") + "\n" +
...
//    }
    ...
    // Make sure only a single tentoescoin process is using the data directory.
    ...
    // requested to kill tentoescoin-qt during the last operation. If so, exit.
